...
!!!note Note
        This is a playground repository for creating AKS clusters using BICEP


To deploy a Bicep file or ARM template, you need write access on the resources you're deploying and access to all operations on the Microsoft.Resources/deployments resource type. For example, to deploy a virtual machine, you need Microsoft.Compute/virtualMachines/write and Microsoft.Resources/deployments/* permissions.<br>

For a list of roles and permissions, see [Azure built-in roles](https://docs.microsoft.com/en-us/azure/role-based-access-control/built-in-roles "Azure built-in roles").
...
## Use the scripts on this github project:

```
# Create Resource Group 
az group create -l WestEurope -n bicep-rg

# Check what it creates with the command what-if
az deployment group create --template-file ./main.bicep --resource-group bicep-rg --what-if

# Pass the parameters for AKS:
az deployment group create --template-file ./main.bicep --resource-group bicep-rg --parameters \
  resourceName=az-k8s-31n5 \
	...
	authorizedIPRanges="[\"148.71.74.140/32\"]" \
...
[AKS-Construction](https://azure.github.io/AKS-Construction/ "AKS-Construction")<br>